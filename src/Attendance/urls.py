...
from Attendance.views.AttView import Create, IndexByUser, daily_index_by_user, daily_report_by_user, Index
...
urlpatterns = [path("api/v1/register", RegisterAPI.as_view(), name="register"),
               ...
               path("api/v1/daily/attendances", daily_index_by_user, name="daily_index"),
               path("api/v1/report/attendances", daily_report_by_user, name="daily_report"),
